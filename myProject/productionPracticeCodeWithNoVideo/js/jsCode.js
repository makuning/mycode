...
function hintColor(hintLocation,imgLength){
    if(event.type == "blur")
    {
        ...
        hintImgs[imgLength].innerHTML = "<img src=\"../image/TOMImg/judge/wrongout.gif\"/>"
    }else{
        hintLocation.style.color = "black";
        hintImgs[imgLength].innerHTML = "<img src=\"../image/TOMImg/judge/wrongin.gif\"/>"
    }
}
                    ...
                    }else   if(ifStringIn(str,mailNameDict) == false)
                            {
                                ...
                                return false;
                            }else   if(str.charAt(0) == "." || str.charAt(0) == "_" || str.charAt(0) == "-")
                                    {
                                        ...
                                        hintImgs[0].innerHTML = "<img src=\"../image/TOMImg/judge/right.jpg\"/>"
    ...
    }else   if(str.length < 6 || str.length > 18)
            {
                ...
                return false;
            }else   if(ifStringIn(str,pswdDict) == false || ifStringIn(str,englishWordDict) == true || ifStringIn(str,numDict) == true)
                    {
                        ...
                        pswdHint.innerText = "";
                        hintImgs[1].innerHTML = "<img src=\"../image/TOMImg/judge/right.jpg\"/>";
                        return true;
                    }
}
    ...
    if(str2.length == 0)
    {
        ...
        return false;
    }else   if(str1 != str2)
            {
                ...
                hintImgs[2].innerHTML = "<img src=\"../image/TOMImg/judge/right.jpg\"/>";
    ...
    if(str.length == 0)
    {
        ...
        return false;
    }else   if(str.length != 11 || ifStringIn(str,numDict) == false || ifInArray(str.substring(0,2),start2PhoneNum) == false)
            {
                ...
                hintImgs[3].innerHTML = "<img src=\"../image/TOMImg/judge/right.jpg\"/>";
...
function verifyBton1Func(){
    ...
    {
        verify.innerHTML = "<p style=\"font-size:15px;color:grey;\">请使用微信<img src=\"../image/TOMImg/wx_icon.png\"/>扫描二维码验证</p> <img style=\"height:150px;width:150px;\" src=\"../image/TOMImg/makunWX.jpg\"/>";
        wxFlag = 1;
        return true;
    }else{
        verify.innerHTML = "<p style=\"font-size:15px;color:grey;\">请使用微信<img src=\"../image/TOMImg/wx_icon.png\"/>扫描二维码验证</p> <img style=\"height:150px;width:150px;\" src=\"../image/TOMImg/code_icon.png\"/>";
        wxFlag = -1;
        return false;
    }
}
