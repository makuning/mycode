...
>                 // 获取定位成功就执行小括号中的函数（执行时自动传入一个参数，这个参数就是位置信息）
>                 // navigator: 翻译为 导航器
>                 // CurrentPosition:翻译为 当前
>                 // 意思就是，导航器对象的获取定位的获取当前位置信息方法，执行这个方法的时候会有回调函数，给这个回调函数传入获取到的位置信息
...
> ```text
> 网址：https://www.runoob.com/css3/css3-transitions.html
> 
...
>      #div1 {
>          left:0px;
>          background-color: rgb(30, 180, 130);
>      }
> 
>      #div2 {
>          left:100%;
...
> ```text
> 网址：https://www.runoob.com/cssref/css3-pr-transform.html
> 
> 
> 语法
...
> ```text
> 参考网址1：https://www.w3school.com.cn/cssref/pr_animation.asp
> 参考网址2：https://www.runoob.com/cssref/css3-pr-animation.html
> 
...
> 
>         @keyframes move1 {
>             from {left: 0px;background-color: aqua;}
>             to {left: -100%;background-color: blueviolet;}
>         }
> 
>         @keyframes move2 {
>             from {left: 100%;top: -100%;background-color: aquamarine;}
>             to {left: 0px;top: -100%;background-color: rgb(216, 205, 255);}
>         }
>     </style>
> </head>
> <body>
